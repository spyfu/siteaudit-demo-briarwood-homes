...
$expectedRepository = 'spyfu/siteaudit-demo-briarwood-homes'
$expectedRemoteHttps = 'https://github.com/spyfu/siteaudit-demo-briarwood-homes.git'
$expectedRemoteSsh = 'git@github.com:spyfu/siteaudit-demo-briarwood-homes.git'
