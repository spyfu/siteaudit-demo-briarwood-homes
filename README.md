# siteaudit-demo-briarwood-homes
...
| --- | --- | --- | --- |
| `demo-01` | `siteaudit-demo-briarwood-homes` | https://siteaudit-demo-briarwood-homes.pages.dev/ | https://github.com/spyfu/siteaudit-demo-briarwood-homes/edit/demo-01/siteaudit-head.html |
| `demo-02` | `siteaudit-demo-briarwood-homes-02` | https://siteaudit-demo-briarwood-homes-02.pages.dev/ | https://github.com/spyfu/siteaudit-demo-briarwood-homes/edit/demo-02/siteaudit-head.html |
| `demo-03` | `siteaudit-demo-briarwood-homes-03` | https://siteaudit-demo-briarwood-homes-03.pages.dev/ | https://github.com/spyfu/siteaudit-demo-briarwood-homes/edit/demo-03/siteaudit-head.html |
| `demo-04` | `siteaudit-demo-briarwood-homes-04` | https://siteaudit-demo-briarwood-homes-04.pages.dev/ | https://github.com/spyfu/siteaudit-demo-briarwood-homes/edit/demo-04/siteaudit-head.html |
| `demo-05` | `siteaudit-demo-briarwood-homes-05` | https://siteaudit-demo-briarwood-homes-05.pages.dev/ | https://github.com/spyfu/siteaudit-demo-briarwood-homes/edit/demo-05/siteaudit-head.html |
...
```powershell
git clone https://github.com/spyfu/siteaudit-demo-briarwood-homes.git
Set-Location siteaudit-demo-briarwood-homes
